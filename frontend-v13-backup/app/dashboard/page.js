...
function DashboardContent() {
  ...
  // ----- Cas ADMIN : vue supervision (liste lecture seule, pas d'analyse) -----
  if (isAdmin) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="mb-4">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Vue de supervision pour l'administration système. L'analyse des
            données est réservée aux Utilisateurs (leurs propres datasets) et
            aux Managers (lecture globale + validation).
          </p>
        </div>
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 text-xs text-gray-600">
              <tr>
                ...
                <th className="text-left py-3 px-4 font-medium">Propriétaire</th>
                <th className="text-left py-3 px-4 font-medium">Lignes</th>
                <th className="text-left py-3 px-4 font-medium">Validation</th>
                <th className="text-left py-3 px-4 font-medium">Importé le</th>
              </tr>
            </thead>
            <tbody>
              {datasets.map((d) => (
                <tr key={d.id} className="border-t border-gray-100">
                  ...
                  <td className="py-3 px-4 text-gray-600">User #{d.user_id}</td>
