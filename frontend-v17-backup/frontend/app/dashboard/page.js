...
const TABS = [
  { key: "overview", label: "Analyse des données" },
  { key: "models", label: "Entraînement des modèles AI" },
  { key: "forecast", label: "Test et prévisions" },
  { key: "anomalies", label: "Anomalies" },
  { key: "categories", label: "Articles & Catégories" },
];
