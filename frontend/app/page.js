...
const ACTORS = [
  {
    ...
    desc: "Importe ses données, consulte son tableau de bord, lance des prévisions ML sur ses propres datasets.",
  },
  {
    role: "Manager",
    color: "bg-amber-50 border-amber-200 text-amber-700",
    desc: "Consulte tous les datasets en lecture, annote et valide les analyses pour la prise de décision stratégique.",
  },
  {
    role: "Administrateur",
    color: "bg-purple-50 border-purple-200 text-purple-700",
    desc: "Gère les comptes, les rôles et supervise le système (utilisateurs, datasets, journal d'activité).",
  },
  {
    role: "Système IA",
